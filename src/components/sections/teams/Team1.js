	...
	return (
		...
		>
			<div className="tj-container">
				...
				<div className="grid grid-cols-1 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 leftSwipeWrap">
					{currentItems?.length
				...
				{type === 2 ? (
					...
					<div
						className="team-btn mt-40 text-center wow fadeInUp md:hidden"
						data-wow-delay="0.9s"
					>
